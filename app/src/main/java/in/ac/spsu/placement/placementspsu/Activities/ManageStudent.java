...
public class ManageStudent extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress = new ProgressDialog(ManageStudent.this);
        ...
        builder = new AlertDialog.Builder(ManageStudent.this);
        ...
        builder.setPositiveButton(getString(R.string.action_logout),new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                dialog.dismiss();
                startActivity(new Intent(ManageStudent.this,LoginActivity.class));
                finish();
            }
        });
    ...
    private void createStudentList() {
        if(CheckNetwork.isNetworkConnected(getApplicationContext())){
            progressDialog.show();
            Call<List<UserData>> call = server.getAllUserByType(0);
            call.enqueue(new Callback<List<UserData>>() {
                ...
                public void onResponse(Call<List<UserData>> call, Response<List<UserData>> response) {
                    ...
                    if(data.size()==0){
                        ...
                        tv.setText(getString(R.string.students_not_found));
    ...
    private void deleteSelectedStudent(final String name, int id, final int pos) {
        if(CheckNetwork.isNetworkConnected(getApplicationContext())){
            progress.show();
            Call<String> call = server.doRemoveUser(id,0);
            call.enqueue(new Callback<String>() {
                ...
                public void onResponse(Call<String> call, Response<String> response) {
                    ...
                    if(data.equals(getString(R.string.success))){
                        ...
                        Toast.makeText(ManageStudent.this, name+" "+getString(R.string.removed), Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(ManageStudent.this, getString(R.string.try_again), Toast.LENGTH_SHORT).show();
                    }
                    progress.dismiss();
                }
                ...
                public void onFailure(Call<String> call, Throwable t) {
                    Toast.makeText(ManageStudent.this, getString(R.string.something), Toast.LENGTH_SHORT).show();
                    progress.dismiss();
                }
            });
        } else {
            Toast.makeText(ManageStudent.this, getString(R.string.no_internet), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            ...
            startActivity(new Intent(ManageStudent.this,ManageCompany.class));
            finish();
            return true;
        } else if (id == R.id.action_password) {
            startActivity(new Intent(ManageStudent.this,ChangePassword.class));
            finish();
            return true;
        }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.action_delete:
                ...
                deleteSelectedStudent(tm.getText().toString(),Integer.parseInt(tv.getText().toString()),info.position);
                break;
        }
