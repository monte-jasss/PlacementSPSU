...
public class ListJobAdapter extends ArrayAdapter {
    List<ListJobData> list = new ArrayList<ListJobData>();
    Holder holder;

    public ListJobAdapter(Context context, int resource) {
    ...
    public void add(ListJobData object) {
        super.add(object);
